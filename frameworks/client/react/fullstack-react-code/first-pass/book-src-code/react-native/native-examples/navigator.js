...
export default class RenderSceneApp1 extends Component {
  renderScene(route) {
    if (route.home === true) {
...
export default class RenderSceneApp2 extends Component {
  renderScene(route, navigator) {
    if (route.home === true) {
...
export default class ConfigureSceneApp1 extends Component {
  configureScene(route) {
    if (route.home === true) {
