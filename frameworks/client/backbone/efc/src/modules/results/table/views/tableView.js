define(function (require) {
  var _ = require('underscore'),
    ...
    ProjectCollection = require('app/modules/results/table/collections/projectsCollection'),
    ItemView = require('app/modules/results/table/views/itemView'),
    tpl = require('text!app/modules/results/table/templates/result-table.html');
